                        ...
                        <div key={order.orderId} className="flex flex-col ring-1 ring-gray-300 rounded-lg p-4">
                                    ...
                                    <div className='w-full'>
                                        ...
                                        <div className='grid grid-cols-4 w-full mt-4'>
                                            ...
                                            <div>
                                                ...
                                                <p>LKR {product.quantity.unit === 'gram' ? (product.quantity.value / 1000) * product.price : product.quantity.value * product.price}</p>
                                            </div>
                                        </div>
                                        <div>
                                            {order.status === 'delivered' && (
                                                <form onSubmit={handleSubmit} className="mt-3 flex justify-between gap-4">
                                                    <textarea
                            ...
                            <div className='grid grid-cols-3 mt-4'>
                                <div>
                                    ...
                                    >
                                        {order.status === 'canceled' ? 'Order Canceled' : order.status === 'delayed' ? 'Order Delayed' : order.status === 'shipped' ? 'Order Shipped' : 'Order Still Progress'}
                                    </p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p>{order.deliveryAddress.street}, {order.deliveryAddress.town}, {order.deliveryAddress.district}</p>
                                </div>
                            </div>
                        </div>
                    ))}
